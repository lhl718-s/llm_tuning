...
os.environ["PYTORCH_CUDA_ALLOC_CONF"] = "max_split_size_mb:128,expandable_segments:True"  # 内存优化
...
output_dir = "/mnt/data/output_rl_grpo7B/train1"
...
training_args = GRPOConfig(
    ...
    per_device_train_batch_size=2,  # 调整为 2
    gradient_accumulation_steps=8,  # 调整为 8
    num_train_epochs=5,
    learning_rate=1e-5,
    optim="adafactor",
    fp16=True,
